...
public class PesosTask extends AsyncTask<String, Integer, List<Pesos>> {

    private ProgressDialog progress;
    private Context context;
    private String method;

    public PesosTask(Context context, String method) {
    ...
    protected void onPreExecute() {
        ...
        progress.setMessage("Estamos cadastrando seus registros de Pesos em nosso sistema...");
    ...
    @Override
    protected List<Pesos> doInBackground(String... jsonData) {
        List<Pesos> racaoResult = new ArrayList<>();
        HttpURLConnection connection = null;
        String data = jsonData[0];
        try {

            StringBuffer response = new StringBuffer();
            connection = Conexao.realizaConexao("Pesos", method);
    ...
    @Override
    protected void onPostExecute(List<Pesos> s) {
